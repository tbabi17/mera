	...
	initComponent: function() {
		 ...
		 views['topbar'] = Ext.create('Ext.Component', {
			...
			html:'<div class="caption">'+
					'<table cellpadding=0 cellspacing=0><tr><td class="padding'+(pk=='dashboard'?' active':'')+'"><a href="index.php?pk=dashboard">Хяналт & GPS</a></td><td class="padding'+(pk=='workspace'?' active':'')+'"><a href="index.php?pk=workspace">Үйл ажиллагаа</a></td><td style="display:none" class="padding'+(pk=='deals'?' active':'')+'"><a href="index.php?pk=deals">Хэлцэл</a></td><td class="padding'+(pk=='reseller'?' active':'')+'" style="display: none"><a href="index.php?pk=reseller">Салбар</a></td><td class="padding'+(pk=='retail'?' active':'')+'"><a href="index.php?pk=retail">Хувь хүн</a></td><td class="padding'+(pk=='corporate'?' active':'')+'"><a href="index.php?pk=corporate">Байгууллага</a></td><td class="padding'+(pk=='cases'?' active':'')+'"><a href="index.php?pk=cases">Санал гомдол</a></td><td style="display:none" class="padding'+(pk=='campaigns'?' active':'')+'"><a href="index.php?pk=campaigns">Маркетинг</a></td><td class="padding'+(pk=='services'?' active':'')+'"><a href="index.php?pk=services">Борлуулалт</a></td><td class="padding'+(pk=='competitor'?' active':'')+'" style="display:none"><a href="index.php?pk=competitor">Өрсөлдөгч</a></td><td class="padding'+(pk=='goal'?' active':'')+'"><a href="index.php?pk=goal">Төлөвлөгөө</a></td><td class="padding'+(pk=='product'?' active':'')+'"><a href="index.php?pk=product">Бараа</a></td><td class="padding'+(pk=='storage'?' active':'')+'"><a href="index.php?pk=product">Агуулах</a></td><td class="padding'+(pk=='reports'?' active':'')+'"><a href="index.php?pk=reports">Тайлан</a></td><td class="padding'+(pk=='settings'?' active':'')+'"><a href="index.php?pk=settings">Тохиргоо</a></td><td class="padding" style="float:right"><a href="logout.php">Гарах</a></td></tr></table>'+
 				 '</div>'
		 });
		 if (pk == 'retail')
